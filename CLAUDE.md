...
- **Ikke referer til kilden i brødteksten.** Leseren har ikke sett slidene/notatene, så «Slide 16 sier …», «fra slidene», «slidenes eksempel», «boka viser» i løpende tekst, oppgavetekst og svar er forstyrrende. Kildehenvisning hører bare hjemme i `source-note`, `eyebrow`, `o-ref`, `o-label`, `answer-src`, `oi-ref`/`oi-status` og «Ekstra»-lista. Skriv innholdet direkte: «Etter \(X_1 = 	ext{red}\) blir …». Egne tillegg merkes «egen tolkning»/«forslag» uten å nevne hva kilden mangler.
