...
2. Brødtekst som **forklarer**, ikke bare gjengir, og som er kort. **Ikke referer til kilden i brødteksten** («slide 16 sier», «fra slidene», «boka viser», «løsningsforslaget skriver»): leseren har ikke sett kilden. Kildehenvisningen står i `source-note`, `eyebrow`, `o-ref`, `o-label` og `answer-src`, ikke i løpende tekst, oppgavetekst eller svar. Videre: maks tre avsnitt før første formel, figur eller oppgave. Historikk, anekdoter, produkteksempler og tall som ikke inngår i noen oppgave kuttes, eller legges i `<details><summary>Utdypning · lavere prioritet</summary>…</details>` om de kan bli spurt om. Første avsnitt i en seksjon kan ha `class="dropcap"`. Bruk kildens ordvalg for fagbegreper. Norsk bokmål, uformell «vi»-stil.
